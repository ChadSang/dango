...
void JsonHandler::expand(string &str)
{
	if (str == "i")
	{
...
void JsonHandler::expand_test(string &str)
{
	if (str == "i")
	{
		str = " { \"type\": \"init\", \"channelCount\" : 2, \"maxDistance\" : 10, \"nodes\" : [ \
...
{\"uuid\": \"uuid-06\", \"pos\" : [18, 0], \"speed\" : [5, 0]} \
	...
	else if (str == "u")
	{
		...
		str = " { \"type\": \"update\", \"nodes\" : [ \
{\"uuid\": \"uuid-01\", \"speed\" : [0, 1]} \
{\"uuid\": \"uuid-02\", \"speed\" : [0, 1]} \
{\"uuid\": \"uuid-03\", \"speed\" : [0, 2]} \
{\"uuid\": \"uuid-04\", \"speed\" : [0, 3]} \
] }";
	}
	else if (str[0] == 'a')
	{
...
void JsonHandler::print(Value obj)
{
	// rm->print();
